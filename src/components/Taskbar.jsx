export default function Taskbar() {
  return (
    <header className="absolute left-0 top-0 z-30 flex h-10 w-full items-center justify-between border-b border-[#2a2a2a] bg-[#030303] px-3 shadow-[0_8px_24px_rgba(0,0,0,0.35)] sm:px-4">
